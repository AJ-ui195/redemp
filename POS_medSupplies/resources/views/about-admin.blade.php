...
<div class="admin-container">
    ...
    <div class="container py-4">
        <div class="card shadow-sm border-0 mb-4 position-relative overflow-hidden" style="background: radial-gradient(circle at 20% 20%, rgba(0,255,170,0.18), transparent 35%), radial-gradient(circle at 85% 10%, rgba(0,123,255,0.16), transparent 40%), linear-gradient(120deg, #0f172a, #0b3b29); color: #fff;">
            ...
            <div class="position-absolute bottom-0 start-0 p-4" style="pointer-events:none;">
                <div style="width:180px; height:90px; border-radius:14px; background: linear-gradient(145deg, rgba(0,255,170,0.18), rgba(76,175,80,0.08)); box-shadow: 0 25px 60px rgba(0,0,0,0.35); transform: rotate(-6deg) translateY(18px); border:1px solid rgba(255,255,255,0.08);"></div>
            </div>
            <div class="card-body d-flex flex-column flex-lg-row align-items-start align-items-lg-center gap-3 position-relative" style="z-index:2;">
                <div class="flex-grow-1">
                    <div class="d-flex align-items-center gap-2 mb-2">
                        <span class="badge bg-success">Admin Suite</span>
                        <span class="badge bg-outline-light border border-light text-light">Analytics</span>
                    </div>
                    <h2 class="mb-1">About This System</h2>
                    <p class="mb-0 text-light opacity-75">REDEMP Medical Supplies &amp; Pharmacy POS Suite</p>
                </div>
                <div class="d-flex flex-wrap gap-2">
                    <div class="rounded-3 px-3 py-2 text-start" style="background: rgba(255,255,255,0.08); box-shadow: 0 12px 30px rgba(0,0,0,0.25); transform: translateZ(8px); border:1px solid rgba(255,255,255,0.08);">
                        ...
                        <div class="fw-semibold">Roles &amp; Audits</div>
                    </div>
                    <div class="rounded-3 px-3 py-2 text-start" style="background: rgba(255,255,255,0.08); box-shadow: 0 12px 30px rgba(0,0,0,0.25); transform: translateZ(8px); border:1px solid rgba(255,255,255,0.08);">
                        <div class="small text-light opacity-75">Insights</div>
                        <div class="fw-semibold">KPIs &amp; Alerts</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                <h5 class="card-title mb-1">Purpose</h5>
                                <p class="text-muted mb-0">Operational control for sales, stock, and compliance.</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="border rounded p-3 h-100">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <strong>Insight &amp; Compliance</strong>
                                    </div>
                                    <ul class="text-muted small mb-0 ps-3">
                                        <li>Sales analytics and shift tracking</li>
                                        <li>Activity logs and approvals</li>
                                        <li>Notifications and audit readiness</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="border rounded p-3 h-100">
                                    ...
                                    <ul class="text-muted small mb-0 ps-3">
                                        <li>Inventory monitoring &amp; expirations</li>
                                        <li>Barcode/QR integration and exports</li>
                                        <li>User roles &amp; system configuration</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
